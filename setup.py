...
setup(
    ...
    description="Device agent for the AI platform that builds, tests, deploys, and operates real software",
    long_description=README,
    long_description_content_type="text/markdown",
    license="PolyForm-Shield-1.0.0",
    author="Meena Erian",
    author_email="hi@menas.pro",
    url="https://portacode.com/",
    project_urls={
        "Homepage": "https://portacode.com/",
        "Start Building": "https://portacode.com/",
